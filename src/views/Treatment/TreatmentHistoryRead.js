    ...
    return(
       ...
       <div className="TreatmentHistoryRead">
        ...
        <table border="1" width="500" height="200">
            <tr>
                <th className="text-center" bgcolor="lightgrey" bordercolor="white">sub</th>
                    <td width="80%">목 아픔</td>
            </tr>
            <tr>
                <th className="text-center" bgcolor="lightgrey" bordercolor="white">obj</th>
                <td width="80%">인후염</td>
            </tr>
            <tr>
                <th className="text-center" bgcolor="lightgrey" bordercolor="white">ass</th>
